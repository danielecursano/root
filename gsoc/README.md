...
In the `sofie_backend` directory, you can find the source code of the new backend, which inherits from `FPGABackend`. In `main.py`, I register the backend and its writer.
